import z4, { uuidv4 } from "zod/v4";
var ServiceAsaas;
(function (ServiceAsaas) {
    let Cobranca;
    (function (Cobranca) {
        let CriarCobrancaBoleto;
        (function (CriarCobrancaBoleto) {
            const billingTypes = ["boleto", "pix", "credit_card"];
            const fineObject = z4.union([z4.literal("PERCENTAGE"), z4.literal("FIXED")]);
            CriarCobrancaBoleto.billingTypeSchema = z4.enum(billingTypes).transform((value) => value.toUpperCase());
            CriarCobrancaBoleto.InputSchema = z4.object({
                data: z4.object({
                    cobranca: z4.object({
                        billingType: CriarCobrancaBoleto.billingTypeSchema,
                        customer: z4.string(),
                        dueDate: z4.date(),
            ...
            CriarCobrancaBoleto.OutputSchema = z4.object({
                object: z4.string(),
                id: z4.string(),
        ...
        })(CriarCobrancaBoleto = Cobranca.CriarCobrancaBoleto || (Cobranca.CriarCobrancaBoleto = {}));
        let BuscarCobranca;
        (function (BuscarCobranca) {
            BuscarCobranca.InputSchema = z4.object({
                data: z4.object({
                    cobranca: z4.object({
            ...
            BuscarCobranca.OutputSchema = z4.object({
                object: z4.string(),
                hasMore: z4.boolean(),
        ...
        })(BuscarCobranca = Cobranca.BuscarCobranca || (Cobranca.BuscarCobranca = {}));
        let DeletarCobranca;
        (function (DeletarCobranca) {
            DeletarCobranca.InputSchema = z4.object({
                data: z4.object({
                    id: z4.string(),
                }),
            });
            DeletarCobranca.OutputSchema = z4.object({
                deleted: z4.boolean(),
                id: z4.string(),
            });
        })(DeletarCobranca = Cobranca.DeletarCobranca || (Cobranca.DeletarCobranca = {}));
    })(Cobranca = ServiceAsaas.Cobranca || (ServiceAsaas.Cobranca = {}));
    let Cliente;
    (function (Cliente) {
        let Criar;
        (function (Criar) {
            Criar.InputSchema = z4.object({
                data: z4.object({
                    cliente: z4.object({
                        name: z4.string(),
                        cpfCnpj: z4.string(),
        ...
        })(Criar = Cliente.Criar || (Cliente.Criar = {}));
        let BuscarPeloFiltro;
        (function (BuscarPeloFiltro) {
            BuscarPeloFiltro.InputSchema = z4.object({
                filtros: z4.object({
                    cliente: z4.object({
            ...
            BuscarPeloFiltro.OutputSchema = z4.object({
        ...
        })(BuscarPeloFiltro = Cliente.BuscarPeloFiltro || (Cliente.BuscarPeloFiltro = {}));
    })(Cliente = ServiceAsaas.Cliente || (ServiceAsaas.Cliente = {}));
    let Notification;
    (function (Notification) {
        Notification.NotificationEventSchema = z4.union([
        ...
        Notification.NotificationConfigSchema = z4.object({
            ...
            event: Notification.NotificationEventSchema,
            scheduleOffset: z4.number(),
            deleted: z4.boolean(),
        });
    })(Notification = ServiceAsaas.Notification || (ServiceAsaas.Notification = {}));
    let Transferencia;
    (function (Transferencia) {
        ...
        Transferencia.TransferenciaSchema = z4.object({
            _id: z4.uuidv4(),
        ...
        let PagarPix;
        (function (PagarPix) {
            PagarPix.InputSchema = z4.object({
                data: z4.object({
                    transferencia: Transferencia.TransferenciaSchema,
                }),
            });
            PagarPix.OutputSchema = z4.object({
                data: {
        ...
        })(PagarPix = Transferencia.PagarPix || (Transferencia.PagarPix = {}));
        let BuscarPeloFiltro;
        (function (BuscarPeloFiltro) {
            BuscarPeloFiltro.InputSchema = z4.object({
                filtros: z4.object({
            ...
            BuscarPeloFiltro.OutputSchema = Transferencia.TransferenciaSchema;
        })(BuscarPeloFiltro = Transferencia.BuscarPeloFiltro || (Transferencia.BuscarPeloFiltro = {}));
        let BuscarPeloId;
        (function (BuscarPeloId) {
            BuscarPeloId.InputSchema = z4.object({
                data: z4.object({
                    _id: z4.string(),
                }),
            });
            BuscarPeloId.OutputSchema = Transferencia.TransferenciaSchema;
        })(BuscarPeloId = Transferencia.BuscarPeloId || (Transferencia.BuscarPeloId = {}));
        let DeletarPeloId;
        (function (DeletarPeloId) {
            DeletarPeloId.InputSchema = z4.object({
                _id: uuidv4(),
            });
            DeletarPeloId.OutputSchema = Transferencia.TransferenciaSchema;
        })(DeletarPeloId = Transferencia.DeletarPeloId || (Transferencia.DeletarPeloId = {}));
    })(Transferencia = ServiceAsaas.Transferencia || (ServiceAsaas.Transferencia = {}));
})(ServiceAsaas || (ServiceAsaas = {}));
