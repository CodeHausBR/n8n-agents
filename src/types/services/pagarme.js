...
// t.Services.CriarCliente.Input
var ServicePagarme;
(function (ServicePagarme) {
    let Cliente;
    (function (Cliente) {
        let Criar;
        (function (Criar) {
    ...
    })(Cliente = ServicePagarme.Cliente || (ServicePagarme.Cliente = {}));
    let Recebedor;
    (function (Recebedor) {
        ...
        (function (Criar) {
            ...
            Criar.RecebedorCompletoOutputSchema = z4.object({
                id: z4.string(),
                name: z4.string(),
                email: z4.string(),
                code: z4.string(),
            ...
            Criar.OutputSchema = Criar.RecebedorCompletoOutputSchema;
        })(Criar = Recebedor.Criar || (Recebedor.Criar = {}));
        let ReceberEventoWebhook;
        (function (ReceberEventoWebhook) {
            ReceberEventoWebhook.InputSchema = z4.object({
                id: z4.string(),
            });
            ReceberEventoWebhook.OutputSchema = Recebedor.Criar.RecebedorCompletoOutputSchema;
        })(ReceberEventoWebhook = Recebedor.ReceberEventoWebhook || (Recebedor.ReceberEventoWebhook = {}));
    })(Recebedor = ServicePagarme.Recebedor || (ServicePagarme.Recebedor = {}));
    let Pedido;
    (function (Pedido) {
        let Criar;
        (function (Criar) {
            ...
            Criar.BoletoSchema = z4
                ...
                .optional();
            Criar.CartaoDeCreditoSchema = z4
                .object({
                capture: z4.boolean(),
                    ...
                    pedido: z4.object({
                        ...
                        payments: z4.array(z4.object({
                            ...
                            checkout: z4.object({
                                ...
                                boleto: Criar.BoletoSchema,
                                pix: Criar.PixSchema,
                                credit_card: Criar.CartaoDeCreditoSchema,
                            }),
                        })),
                    }),
                }),
        ...
        })(Criar = Pedido.Criar || (Pedido.Criar = {}));
        let Deletar;
        (function (Deletar) {
            Deletar.InputSchema = z4.object({
                data: z4.object({
                    id: z4.string(),
                    status: z4.literal("canceled"),
                }),
            });
            Deletar.OutputSchema = z4.object({
                id: z4.string(),
                code: z4.string(),
                amount: z4.number(),
                currency: z4.string(),
        ...
        })(Deletar = Pedido.Deletar || (Pedido.Deletar = {}));
        let WebhookCobranca;
        (function (WebhookCobranca) {
            WebhookCobranca.PixSchema = z4.object({
                id: z4.string(),
                code: z4.string(),
            ...
            WebhookCobranca.CartaoDeCreditoSchema = z4.object({
                amount: z4.number(),
                checkout_payment: z4.object({
                    amount: z4.number(),
                    billing_address_editable: z4.boolean(),
            ...
            WebhookCobranca.BoletoSchema = z4.object({
                amount: z4.number(),
                code: z4.string(),
                created_at: z4.string(),
                currency: z4.string(),
            ...
            const DataSchema = z4.discriminatedUnion("payment_method", [WebhookCobranca.PixSchema, WebhookCobranca.BoletoSchema, WebhookCobranca.CartaoDeCreditoSchema]);
            WebhookCobranca.InputSchema = z4.object({
                id: z4.string(),
                account: z4.object({
                    id: z4.string(),
                    name: z4.string(),
            ...
            WebhookCobranca.OutputSchema = z4.object({});
        })(WebhookCobranca = Pedido.WebhookCobranca || (Pedido.WebhookCobranca = {}));
    })(Pedido = ServicePagarme.Pedido || (ServicePagarme.Pedido = {}));
})(ServicePagarme || (ServicePagarme = {}));
